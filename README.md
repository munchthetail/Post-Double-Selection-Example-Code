...
Downloand the entire repository, then open any of the Example.do files. Set the directory to the path of the saved repository folder.

The program will automatically install neccssary dependencies.
